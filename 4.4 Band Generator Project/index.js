...
app.post("/submit", (req, res) => {
  ...
  let adjective = Math.floor(Math.random() * adj.length);
  let substantive = Math.floor(Math.random() * noun.length);
  let fullName = `${adj[adjective]} ${noun[substantive]}`;

  res.render("index.ejs", { fullBandName: fullName });
});
